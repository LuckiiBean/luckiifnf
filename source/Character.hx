		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel-dead':
				...
				flipX = true;
					...
					case 'luckii':
				// IF THE ANIMATION DOESN'T LOOP I'M GONNA SCREAM
				tex = Paths.getSparrowAtlas('luckii/luckii_assets');
				frames = tex;
				animation.addByPrefix('idle', 'luckii idle', 24);
				animation.addByPrefix('singUP', 'luckii up', 24);
				animation.addByPrefix('singDOWN', 'luckii down', 24);
				animation.addByPrefix('singLEFT', 'luckii left', 24);
				animation.addByPrefix('singRIGHT', 'luckii right', 24);

				addOffset('idle');
				addOffset("singUP", 38, 17);
